...
2. Train YOLO with [train.py](https://github.com/Athenachc/throatUltrasoundDetection/tree/main/frames/train.py). The YOLO weights will be saved automatically. 
